document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateDashboard() {
        ...
        fetch("http://zymzoo.onrender.com/instructors/")
            .then(response => response.json())
            .then(data => {
        ...
        fetch("http://zymzoo.onrender.com/membership-plans/")
            .then(response => response.json())
            .then(data => {
        ...
        // Fetch members
        fetch("http://zymzoo.onrender.com/members/")
            .then(response => response.json())
            .then(data => {
        ...
        // Fetch bookings
        fetch("http://zymzoo.onrender.com/bookings/")
            .then(response => response.json())
            .then(data => {
